...
task :deploy do
  deploy do
    ...
    on :launch do
      command "echo \"gem 'base64'; gem 'logger'; gem 'tdiary-style-gfm', '>= 1.2.0'; gem 'fcgi'; gem 'cgi'; gem 'pstore'; gem 'holiday_japan'; gem 'oga'; gem 'rss'\" > #{fetch(:current_path)}/Gemfile.local"
