...
task :deploy do
  deploy do
    ...
    on :launch do
      command "echo \"gem 'base64'; gem 'tdiary-style-gfm', '>= 1.2.0'; gem 'fcgi'; gem 'commonmarker', '< 1.0'; gem 'holiday_japan'; gem 'oga'; gem 'rexml'; gem 'rss'\" > #{fetch(:current_path)}/Gemfile.local"
